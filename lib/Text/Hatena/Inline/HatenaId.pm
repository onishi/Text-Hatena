...
build_inlines {
    ...
    syntax qr{
        ...
        if ($type && lc $type eq 'icon') {
            ...
            sprintf(
            q{<a href="%s%s/" class="hatena-id-icon"><img src="http://cdn1.www.st-hatena.com/users/%s/%s/profile_s.gif" width="16" height="16" alt="id:%s" class="hatena-id-icon"></a>},
            ...
            my $pre = substr($user, 0, 2);
            sprintf(
            q{<a href="%s%s/" class="hatena-id-icon"><img src="http://cdn1.www.st-hatena.com/users/%s/%s/profile_s.gif" width="16" height="16" alt="" class="hatena-id-icon">id:%s</a>},
            $urlbase, $user, $pre, $user, $user);
